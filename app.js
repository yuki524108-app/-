...
function startAlarmSound() {
  ...
  if (audioContext.state === "suspended") {
    elements.unlockMessage.textContent = "音を開始するには画面を1回タップしてください。";
  }
...
document.addEventListener("pointerdown", resumeAlarmSound);
...
if (new URLSearchParams(location.search).get("ring") === "1" || location.hash === "#ring") {
  window.setTimeout(startRinging, 500);
}
